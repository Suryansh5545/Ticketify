...
from .views import  get_tickets_by_filter, handle_check_in, get_check_in_data, resend_email, get_ticket_id, get_ticket_by_subevents, get_ticket_by_addons
...
urlpatterns = [
    ...
    path('get_ticket_id/', get_ticket_id.as_view(), name='get_ticket_id'),
